...
Route::get('/front', [TaxController::class, 'index'])->name('parent.contact');
Route::get('/new', [taxController::class, 'new'])->name('parent.new');
Route::get('/service', [taxController::class, 'serviceitr'])->name('parent.service');
Route::get('/gst', [taxController::class, 'Gst'])->name('parent.gst');
Route::get('/return', [taxController::class, 'return'])->name('parent.return');
Route::get('/income', [taxController::class, 'Income'])->name('parent.income');
Route::get('/tds', [taxController::class, 'Tds'])->name('parent.tds');
